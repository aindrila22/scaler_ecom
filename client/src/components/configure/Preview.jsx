...
const Preview = () => {
  ...
  if (imageData && imageData.color) {
    const matchedColor = COLORS.find((supportedColor) => supportedColor.value === imageData.color);
    tw = matchedColor ? matchedColor.tw : null;
  }
  
  const modelLabel = MODELS.options.find(
    (value) => value === imageData.model
  )

  let totalPrice = BASE_PRICE
  if (imageData.material === 'polycarbonate')
    totalPrice += PRODUCT_PRICES.material.polycarbonate
  if (imageData.inish === 'textured') totalPrice += PRODUCT_PRICES.finish.textured

...
ReviewColumn.propTypes = {
  reviews: PropTypes.arrayOf(PropTypes.string).isRequired, // Ensure reviews is an array of strings
  className: PropTypes.string, // Optional string for className
  reviewClassName: PropTypes.func, // Optional function for custom class per review index
  msPerPixel: PropTypes.number, // Optional number for animation speed
}
...
function ReviewGrid() {
  const containerRef = useRef(null) // Set default to null
